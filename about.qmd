---
title: "NM2207 Project Dataset Introduction"
---
...
For a deeper dive and an interactive exploration of Dogecoin's price trends, please check out this Shiny application:

```{=html}

<iframe height="600" width="100%" frameborder="no" src="https://dwayneyoongty00.shinyapps.io/myapp/"> </iframe>
```
Or you may also visit the application!
...
[Head on over to the next page where we will go through the data story in depth.](data-story.qmd)
